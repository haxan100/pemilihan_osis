	...
	<section class="content">
			...
			<script type="text/javascript">
				$(function() {
					...
					function getProdi() {
						...
						$.ajax({
							type: "post",
							url: "<?= base_url() ?>/admin/getProdi",
							data: [],
							dataType: "json",
							success: function (r) {
								$.map(r.data, function (e, i) {

									$(`#containerdpm${i}`).highcharts({
										chart: {
		...
		<body>
			<div class="row">
					...
					?>
				<div class="col-6">
						<div id="containerdpm<?= $value->id_prodi?>"></div>	
								...
								<div class="col-md-6 col-sm-6 col-12">
									<div class="info-box bg-info">
										<span class="info-box-icon"> 
											<img class="img-fluid" id="foto_wrapper" data-target="#modalBaru" data-toggle="modal" src="<?=base_url();?>/upload/images/Calon_dpm/<?=$value->foto?>"> </span>
