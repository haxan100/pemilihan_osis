		...
		<div id="alertNotif" class="p-2">
			...
			if ($this->session->flashdata('notifikasi')) {
				...
				<input name='oke' id='oke' class='btn btn-primary' type='hidden' value='1'>
								...
								<script>
								setTimeout(function() {
								window.location.href = '$bu/User/Cart_dpm/$prodi';
							}, 2000);
								</script>
			...
			?>
				<div class="col-md-3 col-sm-6 col-12">
					<div class="info-box bg-primary" style="max-width: 95%;max-height: 100%;">
						<span class="info-box-icon"> <img class="img-fluid" id="foto_wrapper" data-target="#modalBaru" data-toggle="modal" src="<?= base_url(); ?>/upload/images/calon_dpm/<?= $key->foto ?>"> </span>
				...
				if (result.isConfirmed) {
					...
					$.ajax({
						...
						if (e.status) {
							...
							setTimeout(function() {
								window.location.href = "<?= base_url() ?>/User/Cart_dpm";
							}, 2000);
