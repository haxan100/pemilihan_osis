...
public function index()
{
	...
	$this->cekLoginAdmin();
		...
		$obj['siswaSudahMilihBEM'] = count($this->SiswaModel->getAllSiswaHasChose('bem')->result());
		$obj['siswaSudahMilihDPM'] = count($this->SiswaModel->getAllSiswaHasChose('dpm')->result());
